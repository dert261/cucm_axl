...
public class DbLdapAuthenticationProvider2 implements AuthenticationProvider{

	private static Logger logger = LogManager.getLogger(DbLdapAuthenticationProvider2.class);
